...
const steps = [
  ...
  ['G-code panel (live edit, line stepping, restart seq #)', 'node', ['tests/codeEdit.test.js']],
  ['load by program number (remembered folder)', 'node', ['tests/programLoad.test.js']],
  ...
  ...(hasBrowser ? [['tri-dexel visual check (real 3+2 job, real Chromium)', 'node', ['tests/tridexelBrowser.test.js']]] : []),
